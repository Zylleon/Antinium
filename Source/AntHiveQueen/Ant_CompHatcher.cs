...
{
    public class Ant_CompHatcher : ThingComp
    {
        ...
        public void Hatch()
        {
            try
            {
                PawnGenerationRequest request = new PawnGenerationRequest(this.Props.hatcherPawn, this.hatcheeFaction, PawnGenerationContext.NonPlayer, -1, false, true, false, false, true, false, 1f, false, true, true, false, false, false, false, null, null, null, null, null, Gender.Male, null, null);
        ...
        public override void PreAbsorbStack(Thing otherStack, int count)
        {
            ...
            Ant_CompHatcher comp = ((ThingWithComps)otherStack).GetComp<Ant_CompHatcher>();
        ...
        {
            Ant_CompHatcher comp = ((ThingWithComps)piece).GetComp<Ant_CompHatcher>();
